...
class CreateProducerService {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ document, nameProducer, nameFarm, city, estate, agricuturalArea, totalArea, vegetationArea, cropsPlanted }) {
            ...
            const findProducer = yield this.producerRepository.findByDocument(document);
            if (findProducer) {
                throw new appError_1.default("Already exists producer with same document.");
            }
            ...
            const producer = this.producerRepository.create({
                document, nameProducer, nameFarm, city, estate, agricuturalArea, totalArea, vegetationArea, cropsPlanted
            });
            return producer;
        });
    }
...
exports.default = CreateProducerService;
